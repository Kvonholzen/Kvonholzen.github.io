...
address: "Kaete-Hamburger-Weg 3, 37073 Goettingen"
...
notpublished = c("DoppeltDass",
                 "SarahLWLpilot",
                 "ChineseWordLearning",
                 "SpanishFrenchTPs",
                 "SpanishFrenchTPsProsody",
                 "IniSegLexTransparencyLearning"
                 )
...
notpublished = c("IniSegLexTransparencyLearning",
                 "SpanishFrenchTPs")
...
bibliography_entries("data/Publications.bib") %>%
  filter(id %in% "VonHolzen2021" | id %in% "AdultIDSADS" | id %in% "CVaccent" | id %in% "ROFFS" | id %in% "IniSegPhonotactics" | id %in% "IniSegLexTransparency") %>%
  arrange(author)
