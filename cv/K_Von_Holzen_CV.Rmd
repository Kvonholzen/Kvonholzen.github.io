...
edu_data <- read.csv(file = "data/education.csv", header = T, encoding = "UTF-8")
...
grant_data <- read.csv(file = "data/grants.csv", header = T, encoding = "UTF-8")
...
awards_data <- read.csv(file = "data/awards.csv", header = T, encoding = "UTF-8")
...
teaching_data <- read.csv(file = "data/teaching.csv", header = T, encoding = "UTF-8")
...
student_data <- read.csv(file = "data/students.csv", header = T, encoding = "UTF-8")
...
experiment_prog <- read.csv(file = "data/skills.csv", header = T, encoding = "UTF-8")
...
stats_an <- read.csv(file = "data/skills.csv", header = T, encoding = "UTF-8")
...
inst_service <- read.csv(file = "data/service.csv", header = T, encoding = "UTF-8")
...
prof_member <- read.csv(file = "data/memberships.csv", header = T, encoding = "UTF-8")
...
community <- read.csv(file = "data/community.csv", header = T, encoding = "UTF-8")
