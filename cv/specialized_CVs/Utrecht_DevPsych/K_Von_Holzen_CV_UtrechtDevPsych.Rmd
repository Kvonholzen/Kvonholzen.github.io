...
research_area <- read.csv(file = "data/research_areas_DevPsych.csv", header = T)
...
I will serve as a member of the reading committee for Mareike Sahling's PhD thesis entitled “Effects of Otitis Media with Effusion on Speech Perception and Production in Preschoolers” at the University of Macquarie, Australia in Spring 2023 and as an external examiner for Paul Ratnage's PhD viva entitled "The phonetic specificity of British English-learning infants’ word form recognition in their first year of life" at the University of Plymouth, UK in Summer 2023.
