...
\textbf{Second-language; Foreign-language; Bilingual; First-language}\hfill{\footnotesize }\newline
  ...
  \empty%
\vspace{\parsep}}\\
Psycholinguistics & \parbox[t]{0.85\textwidth}{%
\textbf{Mechanisms underlying linguistic transfer; Individual differences in linguistic and cognitive skills; Phono-lexical interface}\hfill{\footnotesize }\newline
  \empty%
  \empty%
\vspace{\parsep}}\\
