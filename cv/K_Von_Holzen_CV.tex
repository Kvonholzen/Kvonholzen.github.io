...
\textbf{Habilitation, English Linguistics}\hfill{\footnotesize }\newline
  Technische Universität Braunschweig, Germany\par%
  \empty%
\vspace{\parsep}}\\
...
\hypertarget{bibliography}{}
\leavevmode\vadjust pre{\hypertarget{ref-VonHolzen2018d}{}}%
\CSLLeftMargin{1. }%
...
\textbf{GDR Neurosciences Cognitives du Développement bourses de mobilité à des doctorants}\hfill{\footnotesize }\newline
...
\textbf{Universitätsbund Göttingen Travel Grant}\hfill{\footnotesize }\newline
...
\textbf{Julia Heimann}\hfill{\footnotesize TU Dortmund}\newline
  Auswirkungen kindgerichteter Sprache auf die Merkfähigkeit von Wörtern (The role of child-directed speech on the acquisition of words)\par%
  \empty%
\vspace{\parsep}}\\
2021-2022 & \parbox[t]{0.85\textwidth}{%
...
\textbf{Antonia Gutland}\hfill{\footnotesize TU Dortmund}\newline
  Der Zusammenhang zwischen dem sozioökonimische Status, der Häufigkeit des Vokabelinputs und dem Wortschatz von bilingualen Kindern (The relationship between SES, input frequency, and vocabulary in bilingual children)\par%
  \empty%
\vspace{\parsep}}\\
2021 & \parbox[t]{0.85\textwidth}{%
...
\vspace{\parsep}}\\
2012 & \parbox[t]{0.85\textwidth}{%
\textbf{Deborah Wolff}\hfill{\footnotesize Georg-August-Universität Göttingen}\newline
  Segmentierungsfähigkeit von infant- und adult-directed speech bei 11-13 Monate alten Kindern. Eine ERP-Studie. (Segmentation abilities in infant- and adult directed speech in 11-13 month old children: An ERP study)\par%
  \empty%
\vspace{\parsep}}\\
\end{longtable}
...
\textbf{Co-founder and organizer, Parisian BabyLab Meetings (PaBaLa)}\hfill{\footnotesize }\newline
  Université Paris Descartes\par%
  \empty%
\vspace{\parsep}}\\
2014-2016 & \parbox[t]{0.85\textwidth}{%
