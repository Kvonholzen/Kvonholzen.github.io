...
\textbf{First Language Acquisition}\hfill{\footnotesize }\newline
...
\vspace{\parsep}}\\
2023-  & \parbox[t]{0.85\textwidth}{%
\textbf{Phonetics and Phonology}\hfill{\footnotesize }\newline
  Bachelors in English Studies, TU Braunschweig\par%
  \vspace{0.1cm}\begin{minipage}{0.7\textwidth}%
\begin{itemize}%
\item Average Evaluation: 1,1 (German grading system)%
\end{itemize}%
\end{minipage}%
\vspace{\parsep}}\\
2022-  & \parbox[t]{0.85\textwidth}{%
...
\textbf{Melina Rusche}\hfill{\footnotesize TU Braunschweig}\newline
  Usage of Prosodic Cues: Monolingual and Bilingual Infants' Word Segmentation Abilities in Rhythmically Different Languages\par%
  \empty%
\vspace{\parsep}}\\
2022 & \parbox[t]{0.85\textwidth}{%
...
\hypertarget{bibliography}{}
\leavevmode\vadjust pre{\hypertarget{ref-iVH2024c}{}}%
\CSLLeftMargin{1. }%
\CSLRightInline{Von Holzen, K. (2024). \emph{Foreign language processing
before instruction: Speech segmentation in pre-EFL children}. Presented
at the Centre for Language Studies Colloquium Series, Radboud
University, Netherlands.}

\leavevmode\vadjust pre{\hypertarget{ref-iVH2024b}{}}%
\CSLLeftMargin{2. }%
\CSLRightInline{Von Holzen, K. (2024). \emph{Meta-analysis and
mispronunciations: An introduction to meta-analyses}. Presented at the
Child Language Lab Colloquium, Chosun University, South Korea.}

\leavevmode\vadjust pre{\hypertarget{ref-iVH2024a}{}}%
\CSLLeftMargin{3. }%
\CSLRightInline{Von Holzen, K. (2024). \emph{Realizing accessibility and
improving reliability in developmental science: Remote, online testing
with ManyBabies-AtHome}. Presented at the Workshop {``Learning in Babies
and Machines: Reciprocal Insights and Methodological Synergies,''}
Chosun Center for Data Science in Humanities, South Korea.}
