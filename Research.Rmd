...
# Foreign speech segmentation

My current research at the TU Braunschweig focuses on the first steps of processing and acquisition in a new language for *ab initio* learners, who haven't had any instruction in the new language, as well as experienced learners of that language. I study word segmentation, or segmenting the incomings speech stream into individual words, one of the first challenges facing a learner in a new language. In particular, I'm interested in how different modifications to the input can influence this initial processing, concentrating on:

* learner-directed speech modifications, such as infant- or foreigner-directed speech
* similarities between the new language and languages the learner already knows, with an emphasis on lexical transparency and phonotactics

# Initial foreign speech segmentation in school-aged children (DFG-funded project)
...
Find out more about our project at [ini-seg.de](ini-seg.de)
