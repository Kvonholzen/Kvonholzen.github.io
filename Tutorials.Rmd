...
4. [Lexical Decision Experiment in OSWeb Tutorial](Tutorials_Open_Sesame_Lexical_decision_OSWeb.html)
...
Tutorial guide for how to load data recorded with an Eyelink eyetracker into R, clean the data, and then analyse it. You can access the tutorial [here](https://bookdown.org/katie_m_vonholzen/Eyetracking_Statistical_Analysis_Tutorial/).
...
A short [presentation](files/Macquarie_Presentation.pdf) I gave at the CLaS Eye-tracking Workshop held at Macquarie University On September 8th, 2022, titled "Using cluster-based permutation tests to analyze eye-tracking data". The presentation has a [companion tutorial](https://kvonholzen.github.io/Macquarie_Presentation_buddy.html).
