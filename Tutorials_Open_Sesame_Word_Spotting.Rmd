...
* "completed" folder: This folder contains two finished versions of the experiment. The first "wordspotting_study_1st_test_run" is the intermediate version of the experiment at Step 9 of this Tutorial. The second "wordspotting_study_finished" is the final version of this experiment after completing this Tutorial. These example experiments are provided for you to check in case you run into a problem.
...
# Step 13: Pseudorandomize and set up the experimental variables
...
This is the for loop with r_ticker and the exp.set() functions. Remember to change the code to reflect the names of variables we are using in this experiment (category, wav_file, recording).
